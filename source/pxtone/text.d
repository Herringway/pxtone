...
bool _read4_malloc( char **pp, int* p_buf_size, pxtnDescriptor *p_doc ) nothrow
{
	...
	*pp = cast(char *)malloc( *p_buf_size + 1 );
	...
	if( *p_buf_size )
	{
		if( !p_doc.r( *pp, char.sizeof, *p_buf_size ) ) goto term;
	}
...
public :
	~this() nothrow
	{
		SAFE_DELETE( _p_comment_buf); _comment_size = 0;
	...
	bool is_comment_buf() const nothrow { if( _comment_size > 0 ) return true; return false; }
